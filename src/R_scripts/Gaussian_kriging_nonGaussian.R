...
num_sim = 10
file_path = paste0("synthetic_data_simulations_nonGaussian/training_data/2D_nonGaussian_1200_",1,"-train.csv")
  data_train = read.csv(file_path, header = T)
  file_path = paste0("synthetic_data_simulations_nonGaussian/testing_data/2D_nonGaussian_1200_",1,"-test.csv")
...
parallel.function.lmc = function(sim){
	source("R_scripts/GKriging_functions.R")
  file_path = paste0("synthetic_data_simulations_nonGaussian/training_data/2D_nonGaussian_1200_",sim,"-train.csv")
  data_train = read.csv(file_path, header = T)
  file_path = paste0("synthetic_data_simulations_nonGaussian/testing_data/2D_nonGaussian_1200_",sim,"-test.csv")
  data_test = read.csv(file_path, header = T)
