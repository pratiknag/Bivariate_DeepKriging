...
MSE_variable1_nonstat = c()
MSE_variable2_nonstat = c()
...
for(i in 1:10){
 # df = do.call(rbind, Map(data.frame,x = exa_data$x, y = exa_data$y, var1=exa_data$var1,var2 = exa_data$var2))
  ...
  MSE_var1_LMC = mean((pred[1:400]-test.data$var1)^2)
  MSE_var2_LMC = mean((pred[401:800]-test.data$var2)^2)
...
save.image("plot_results/data_NONSTAT_1200_.Rdata")
